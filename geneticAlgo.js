...
function crossover(parents) {
  var child = new Bird(parents[0].brain)
  for (var i = 0; i < parents[0].brain.weights_ho.length; i++) {
    child.brain.weights_ho[i] =
      (parents[0].brain.weights_ho[i] +
        parents[1].brain.weights_ho[i]) / 2;
  }
  return child.copy();
}
